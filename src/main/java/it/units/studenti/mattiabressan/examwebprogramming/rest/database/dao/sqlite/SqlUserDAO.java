package it.units.studenti.mattiabressan.examwebprogramming.rest.database.dao.sqlite;
...
public class SqlUserDAO implements UserDAO {
    ...
    public SqlUserDAO( it.units.studenti.mattiabressan.examwebprogramming.rest.database.connection.Connection connection ) {
